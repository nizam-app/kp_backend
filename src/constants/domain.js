...
export const ISSUE_TYPES = Object.freeze({
  ...
  AIR_PNEUMATIC_SYSTEM: "AIR_PNEUMATIC_SYSTEM",
  TRANSMISSION_GEARBOX: "TRANSMISSION_GEARBOX",
  OIL_FLUID_LEAK: "OIL_FLUID_LEAK",
  LIGHTS_NOT_WORKING: "LIGHTS_NOT_WORKING",
  TRAILER_COUPLING_ISSUE: "TRAILER_COUPLING_ISSUE",
...
export const JOB_CATEGORY_SUBTYPE_TO_ISSUE_TYPE = Object.freeze({
  ...
  BRAKE_ISSUES_WARNING_LIGHT: ISSUE_TYPES.BRAKE_PROBLEM,
  ELECTRICAL_PROBLEM: ISSUE_TYPES.ELECTRICAL_ISSUE,
  OVERHEATING_COOLANT_LEAK: ISSUE_TYPES.OVERHEATING,
  AIR_PNEUMATIC_SYSTEM: ISSUE_TYPES.AIR_PNEUMATIC_SYSTEM,
  TRANSMISSION_GEARBOX: ISSUE_TYPES.TRANSMISSION_GEARBOX,
  OIL_FLUID_LEAK: ISSUE_TYPES.OIL_FLUID_LEAK,
  LIGHTS_NOT_WORKING: ISSUE_TYPES.LIGHTS_NOT_WORKING,
  TRAILER_COUPLING_ISSUE: ISSUE_TYPES.TRAILER_COUPLING_ISSUE,
  OTHER_NOT_SURE: ISSUE_TYPES.OTHER_DESCRIBE_IN_NOTES,
